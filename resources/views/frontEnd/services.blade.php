        ...
        <div class="container">
            ...
            <div class="service-section">
                ...
                <div class="service-img">
                    <figure>
                        <img src="{{asset('frontEnd/images/programming.gif')}}"
                             alt="{{ App::getLocale() == 'ar' ? $service->title_ar : $service->title_en }}" srcset=""/>
                    </figure>
                </div>
            </div>
            ...
            @foreach($service_details as $service_detail)
                <div class="solution-section">
                    <h5 class="solution-head"
                        style="margin-bottom: 20px !important;">{{App::getLocale() == 'ar' ? $service_detail->title_ar : $service_detail->title_en}}</h5>
                    <div style="color: #fff " class="mb-5">
