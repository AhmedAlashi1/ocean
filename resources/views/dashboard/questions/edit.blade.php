...
@section('title', __('general.Update Question') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('general.Update Question')}}</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                ...
                                                rows="3"
                                                required
                                                placeholder="{{__('general.Do you offer website maintenance services?')}}">{{ $question->question_en }}</textarea>
                                        </div>
                                        @error('question')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                ...
                                                rows="3"
                                                required
                                                placeholder="{{__('general.Do you offer website maintenance services?')}}">{{ $question->question_ar }}</textarea>
                                        </div>
                                        @error('question_ar')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                name="answer"
                                                data-length="1000"
                                                class="form-control char-textarea @error('answer') is-invalid @else {{ old('answer') ? 'is-valid' : '' }} @enderror"
                                                id="textarea-counter"
                                                rows="3"
                                                required
                                                placeholder="absolutely! I have experience workin...">{{ $question->answer_en }}</textarea>
                                        </div>
                                        @error('answer')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                ...
                                                rows="3"
                                                required
                                                placeholder="absolutely! I have experience workin...">{{ $question->answer_ar }}</textarea>
                                        </div>
                                        @error('answer')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
