...
{{--                                    html--}}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                id="blog_type_id">
                                                <option selected>{{__('general.Select a blog type')}}</option>
                                                @foreach($blogTypes as $blogType)
                                                    <option value="{{ $blogType->id }}" {{ old('blog_type_id') == $blogType->id ? 'selected' : '' }}>
                                                        {{ $blogType->name_en }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="way_to_add_blog" class="col-form-label-sm">{{__('general.Way to Add the Blog')}}</label>
                                            <select
                                                ...
                                                <option value="manual" {{ old('way_to_add_blog') === 'manual' ? 'selected' : '' }}>{{__('general.Manual')}}</option>
                                                <option value="short_link" {{ old('way_to_add_blog') === 'short_link' ? 'selected' : '' }}>{{__('general.Short Link')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-12" id="short-link-input" style="display: {{ old('way_to_add_blog') === 'short_link' ? 'block' : 'none' }};">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                name="short_link"
                                                id="short_link"
                                                class="form-control @error('short_link') is-invalid @else {{ old('short_link') ? 'is-valid' : '' }} @enderror"
                                                placeholder="Enter short link"
                                                value="{{ old('short_link') }}">
