        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route('ServiceDetails.update',$service_details->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            placeholder="john"
                                            value="{{$service_details->title_en}}"
                                            required
                                        />
                                        @error('title_en')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            placeholder="john"
                                            value="{{$service_details->title_ar}}"
                                            required
                                        />
                                        @error('title_ar')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
