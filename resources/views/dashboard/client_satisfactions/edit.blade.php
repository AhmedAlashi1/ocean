...
@section('title', __('general.Update client satisfaction') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('general.Update client satisfaction')}}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('client_satisfactions.update',$client_satisfy) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="col-form-label-sm" for="name_ar">{{__('general.Name in english')}}</label>
                                        <input
                                            value="{{$client_satisfy->name_en}}"
                                            name="name"
                                            type="text"
                                            id="name"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            value="{{ $client_satisfy->nick_name_en }}"
                                            type="text"
                                            id="nick_name"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            value="{{ $client_satisfy->nick_name_ar }}"
                                            type="text"
                                            id="nick_name_ar"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                ...
                                                id="textarea-counter"
                                                rows="3"
                                                placeholder="Experience the high level of satisfaction our clients...">{{$client_satisfy->content_en}}</textarea>
                                        </div>
                                        @error('content')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-label-group mb-0">
                                            <textarea
                                                ...
                                                id="textarea-counter"
                                                rows="3"
                                                placeholder="{{__('general.Experience the high level of satisfaction our clients...')}}">{{$client_satisfy->content_ar}}</textarea>
                                        </div>
                                        @error('content_ar')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
