            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('Update Work')}}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('work.update',$work->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select
                                                name="service_id"
                                                class="form-control mb-1 @error('service_id') is-invalid @else {{ old('service_id', $work->service_id) ? 'is-valid' : '' }} @enderror"
                                                id="service_id">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select
                                                name="status"
                                                required
                                                class="form-control mb-1 @error('status') is-invalid @else {{ old('status', $work->status) ? 'is-valid' : '' }} @enderror"
                                                id="status">
                                                <option selected>{{__('general.Select status')}}</option>
                                                <option value="0" {{ old('status', $work->status) === '0' ? 'selected' : '' }}>{{__('general.Hide')}}</option>
                                                <option value="1" {{ old('status', $work->status) === '1' ? 'selected' : '' }}>{{__('general.Show')}}</option>
                                            </select>
                                            @error('status')
                                            <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select
                                                name="is_contact_us"
                                                required
                                                class="form-control mb-1 @error('is_contact_us') is-invalid @else {{ old('is_contact_us', $work->is_contact_us) !== null ? 'is-valid' : '' }} @enderror"
                                                id="is_contact_us">
                                                <option selected>{{__('general.Select option')}}</option>
                                                <option value="0" {{ old('is_contact_us', $work->is_contact_us) === '0' ? 'selected' : '' }}>{{__('general.No')}}</option>
                                                <option value="1" {{ old('is_contact_us', $work->is_contact_us) ? 'selected' : '' }}>{{__('general.Yes')}}</option>
                                            </select>
                                            @error('is_contact_us')
                                            <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted d-block mt-2" style="opacity: 1;">
                                                {{__('general.Note: Uploading new images will replace all existing images for this work.')}}
                                            </small>
                                        </div>
                                    </div>
