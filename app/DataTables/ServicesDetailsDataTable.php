...
class ServicesDetailsDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($service) {
                ...
                return view('components.datatable.actions',
                    [
                        'routeEdit'=>'ServiceDetails.edit',
                        'routeDelete'=>'ServiceDetails.destroy',
                        'routeSoftwareSolutionServices' => 'SolutionServices.index',
                        'id' => $service->id,
                        'name' => $name
                    ]);
            })
     ...
     */
    public function query(ServiceDetails $model , Request $request): QueryBuilder
    {
        $id = $request->route('id');
        $query = $id ? $model->newQuery()->where('service_id', $id) : $model->newQuery();
        return $query->latest();
    }
    ...
    {
        return 'ServiceDetails_' . date('YmdHis');
    }
}
